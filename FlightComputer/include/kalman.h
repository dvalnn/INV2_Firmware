...
class ekf{
    public: 
        ...
        MatrixXf A,P,H,Q,R,K,B,U,X,Z;//Z and X must be Line vectors
...
/// @brief orientation Kalman filter @paragraph   
/// x[0]->qw  
/// x[1]->qx  
/// x[2]->qy  
/// x[3]->qz  
...
class orientation: public ekf{
    ...
    public:
        ...
        /// @param new_U new inputs
        /// @return state
        MatrixXf cicle(MatrixXf new_Z, MatrixXf new_U);
};

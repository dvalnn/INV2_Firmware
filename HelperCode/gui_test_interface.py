...
def arm():
    ...
    rep = ser.read(6)
    if(len(rep) != 6 or int(rep[1]) != command_map['ARM_ACK'] or int(rep[3]) != 1):
    ...
    rep = ser.read(6)
    if(len(rep) != 6 or int(rep[1]) != command_map['ARM_ACK'] or int(rep[3]) != 2):
    ...
    rep = ser.read(6)
    if(len(rep) != 6 or int(rep[1]) != command_map['ARM_ACK'] or int(rep[3]) != 3):

The .pde files and the "data" folder make up the ground station GUI. Made with processing-java programming language, for more information regarding this refer to https://processing.org. 
